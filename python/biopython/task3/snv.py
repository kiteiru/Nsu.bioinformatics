...
searchHuman = "Clock[Gene] AND Homo sapiens[Organism]"

handle = Entrez.esearch(db="gene", term=searchHuman)
...
'''for id in idList:
    ...
    handle = Entrez.efetch(db="snp", id=idx, rettype="gb", retmode="text")
    record = handle.read()
